...
Route::get('/begler-05', 'Auth\LoginController@showLoginForm')->name('login');
Route::post('/begler-05', 'Auth\LoginController@login');
Route::post('/begler-06', 'Auth\LoginController@logout')->name('logout');
